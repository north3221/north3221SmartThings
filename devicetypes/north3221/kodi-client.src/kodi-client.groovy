...
metadata {
    ...
    tiles(scale: 2) {
        ...
        standardTile("shutdown", "device.shutdown", width: 1, height: 1, decoration: "ring") {
            ...
            state "default", label:'${currentValue}', action:"shutdown", icon:"https://raw.githubusercontent.com/north3221/north3221SmartThings/master/resources/shutdown-icon.png", backgroundColor:tileWhite, defaultState: true
